      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            title: Text('compass3@chrisstayte.com'),
          ),
          ListTile(
            onTap: () async {
              final Uri uri = Uri(
                scheme: 'https',
                path: 'www.github.com/chrisstayte/compass',
              );
          ...
          ListTile(
            onTap: () async {
              final Uri uri = Uri(
                scheme: 'https',
                path: 'www.chrisstayte.app/compass3/privacy',
              );
          ...
          ListTile(
            onTap: () async {
              final Uri uri = Uri(
                scheme: 'https',
                path: 'www.chrisstayte.app/compass3/terms',
              );
          ...
          ListTile(
            onTap: () async {
              final Uri uri = Uri(
                scheme: 'https',
                path: 'www.chrisstayte.app/compass3',
              );
